 ...
 * @author Han
 */
@UpnpService(serviceId = @UpnpServiceId("Renraku"), serviceType = @UpnpServiceType(value = "Renraku", version = 1))
public class Renraku extends PhoneGUI {
	...
	@UpnpAction
	public void setStatus(@UpnpInputArgument(name = "NewStatusValue") boolean newTargetValue) {
